...
const api: ElectronAPI = {
  ...
  gloamAuth: {
    config: () => ipcRenderer.invoke("gloam-auth-config"),
    ...
    startGoogle: () => ipcRenderer.invoke("gloam-auth-start-google"),
    startTelegram: () => ipcRenderer.invoke("gloam-auth-start-telegram"),
